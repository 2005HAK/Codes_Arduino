...
void setup() 
{
  ...
  pinMode(bot2, INPUT);//Botao 2 "Alterar valores" setado como entrada
...
static void tocar()
{
  ...
  else
  {
    ...
    delay(250);//Tambem aguarda 500 ms mas como aão duas notas para tocar é aguradado 250 ms para cada
    }
  }
}
